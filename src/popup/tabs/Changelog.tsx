	...
	return (
		<TabTemplate value="changelog">
			...
			<SingleChangelog version="v2.5.10">
				<li>
					The OCO feature has been removed from the extension by Skinport's request due to legal reasons with the shortened checkout process. We have never supported botting and are happy to
