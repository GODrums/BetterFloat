...
import { ICON_CSBLUEGEM, ICON_SKINSMONKEY_FULL } from '~lib/util/globals';
...
interface SkinsmonkeySettingsProps {
	hasProPlan: boolean;
}

export const SkinsmonkeySettings = ({ hasProPlan }: SkinsmonkeySettingsProps) => {
	const [checked] = useStorage<boolean>('sm-enable');
	...
	return (
		<TabTemplate value="skinsmonkey" checked={checked}>
			...
			<SettingsEnable id="sm-enable" isPremiumFeature hasProPlan={hasProPlan} />
			<div className="">
				...
				<div className="flex flex-col gap-1">
					...
					<SettingsCard>
						<SettingsCheckbox id="sm-stickerprices" text="Sticker Prices" icon={<PhSticker className="h-6 w-6" />} disabled />
					</SettingsCard>
				</div>
			</div>
			<div className="">
				...
				<div className="flex flex-col gap-1">
					<SettingsSource prefix="sm" />
					<SettingsCard>
						<SettingsCheckbox
							id="sm-buffdifference"
			...
			<div className="mb-2">
				...
				<div className="flex flex-col gap-1">
					<SettingsCard>
						<SettingsCheckbox id="sm-listingage" text="Show Listing Age" icon={<IcRoundAccessTime className="h-6 w-6" />} disabled />
					</SettingsCard>
				</div>
			</div>
		</TabTemplate>
