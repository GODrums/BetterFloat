...
import { HugeiconsEuroCircle, IcOutlineDiscount, MdiSteam, PhSticker, StreamlineDiscountPercentCoupon } from '~popup/components/Icons';
				...
				<div className="flex flex-col gap-1">
					...
					<SettingsCard>
						<SettingsCheckbox
							...
							tooltipText="Display the ratio of an item's price to the reference price in percentage. Price equality equates to 100%."
