...
export function MaterialSymbolsFilterAlt(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
			<path fill="currentColor" d="M11 20q-.425 0-.712-.288T10 19v-6L4.2 5.6q-.375-.5-.112-1.05T5 4h14q.65 0 .913.55T19.8 5.6L14 13v6q0 .425-.288.713T13 20z"></path>
		</svg>
	);
}
...
export function SolarInfoSquareLinear(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
			<g fill="none">
				<path stroke="#888888" strokeLinecap="round" strokeWidth={1.5} d="M12 17v-6"></path>
				<circle cx="1" cy="1" r="1" fill="#888888" transform="matrix(1 0 0 -1 11 9)"></circle>
				<path
					stroke="#888888"
					strokeWidth={1.5}
...
export function MaterialSymbolsTravelExplore(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
			<path
				fill="#888888"
				d="M12 22q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q3.65 0 6.388 2.288t3.412 5.737h-2.05q-.475-1.825-1.713-3.262T15 4.6V5q0 .825-.587 1.413T13 7h-2v2q0 .425-.288.713T10 10H8v2h2v3H9l-4.8-4.8q-.075.45-.137.9T4 12q0 3.275 2.3 5.625T12 20zm9.1-.5l-3.2-3.2q-.525.3-1.125.5T15.5 19q-1.875 0-3.187-1.312T11 14.5q0-1.875 1.313-3.187T15.5 10q1.875 0 3.188 1.313T20 14.5q0 .675-.2 1.275t-.5 1.125l3.2 3.2zM15.5 17q1.05 0 1.775-.725T18 14.5q0-1.05-.725-1.775T15.5 12q-1.05 0-1.775.725T13 14.5q0 1.05.725 1.775T15.5 17"
			></path>
		</svg>
	);
}
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
			<g fill="none" stroke="#888888" strokeLinecap="round" strokeWidth={2}>
				...
				<path d="m12 12l4 10l1.7-4.3L22 16Z"></path>
			</g>
		</svg>
	);
}
...
export function MaterialSymbolsAvgTimeOutlineRounded(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
			<path
				fill="#888888"
				d="M5.075 12H8q.275 0 .525.138t.375.412l1.1 2.2l3.1-6.2q.275-.575.9-.575t.9.575L16.625 12h2.3Q18.55 9.45 16.6 7.725T12 6Q9.35 6 7.4 7.725T5.075 12M12 20q2.65 0 4.6-1.725T18.925 14H16q-.275 0-.525-.137t-.375-.413l-1.1-2.2l-3.1 6.2q-.275.575-.9.575t-.9-.575L7.375 14h-2.3q.375 2.55 2.325 4.275T12 20m0 2q-1.85 0-3.487-.712T5.65 19.35q-1.225-1.225-1.937-2.863T3 13h2q0 2.9 2.05 4.95T12 20q2.9 0 4.95-2.05T19 13h2q0 1.85-.712 3.488T18.35 19.35q-1.225 1.225-2.863 1.938T12 22m-9-9q0-1.85.713-3.488T5.65 6.65q1.225-1.225 2.863-1.937T12 4q1.55 0 2.975.5t2.675 1.45l.7-.7q.275-.275.7-.275t.7.275q.275.275.275.7t-.275.7l-.7.7Q20 8.6 20.5 10.025T21 13h-2q0-2.9-2.05-4.95T12 6Q9.1 6 7.05 8.05T5 13zm7-10q-.425 0-.712-.288T9 2q0-.425.288-.712T10 1h4q.425 0 .713.288T15 2q0 .425-.288.713T14 3zm2 17q-2.9 0-4.95-2.05T5 13q0-2.9 2.05-4.95T12 6q2.9 0 4.95 2.05T19 13q0 2.9-2.05 4.95T12 20m0-7"
			></path>
		</svg>
	);
}
...
export function CarbonFilterReset(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" {...props}>
			<path fill="currentColor" d="M22.5 9a7.452 7.452 0 0 0-6.5 3.792V8h-2v8h8v-2h-4.383a5.494 5.494 0 1 1 4.883 8H22v2h.5a7.5 7.5 0 0 0 0-15"></path>
			<path fill="currentColor" d="M26 6H4v3.171l7.414 7.414l.586.586V26h4v-2h2v2a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-8l-7.414-7.415A2 2 0 0 1 2 9.171V6a2 2 0 0 1 2-2h22Z"></path>
		</svg>
	);
}
...
export function StreamlineDiscountPercentCoupon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 14 14" {...props}>
			<g fill="none" stroke="#888888" strokeLinecap="round">
				<path d="M.5 11a1 1 0 0 0 .998 1h11.004a1 1 0 0 0 .998-1V8.966a2.037 2.037 0 0 1 0-3.932V3a1 1 0 0 0-.998-1H1.498A1 1 0 0 0 .5 3v2.03a2.037 2.037 0 0 1 0 3.94zm4.02-1.5l5-5"></path>
				<path d="M5.02 5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m4 4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"></path>
			</g>
		</svg>
	);
}
...
export function IcOutlineDiscount(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
			<path fill="#888888" d="M12.79 21L3 11.21v2c0 .53.21 1.04.59 1.41l7.79 7.79c.78.78 2.05.78 2.83 0l6.21-6.21c.78-.78.78-2.05 0-2.83z"></path>
			<path
				fill="#888888"
			...
			></path>
			<circle cx="7.25" cy="4.25" r="1.25" fill="#888888"></circle>
		</svg>
	);
}
