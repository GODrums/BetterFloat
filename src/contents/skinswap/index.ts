...
import { getSkinswapChinaItem, getSkinswapItem, getSkinswapUserItem } from './cache';
import { activateSkinswapEventHandler as activateHandler } from './events';
...
async function getBuffItem(item: Skinswap.Item) {
	...
	const referencePrice =
		Number(extensionSettings['ss-pricereference']) === 0 &&
