...
import { activateDMarketEventHandler as activateHandler } from '~lib/sites/dmarket/events';
...
import { activateDMarketUrlHandler as dynamicUIHandler, mountDMarketMarketComparison } from '~lib/sites/dmarket/url';
