...
function MajesticonsLightningBolt(props: SVGProps<SVGSVGElement>) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}><path fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 14L14 3v7h6L10 21v-7z"></path></svg>);
}

function MaterialSymbolsAddCircleOutlineRounded(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M11 13v3q0 .425.288.713T12 17q.425 0 .713-.288T13 16v-3h3q.425 0 .713-.288T17 12q0-.425-.288-.712T16 11h-3V8q0-.425-.288-.712T12 7q-.425 0-.712.288T11 8v3H8q-.425 0-.712.288T7 12q0 .425.288.713T8 13zm1 9q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22m0-2q3.35 0 5.675-2.325T20 12q0-3.35-2.325-5.675T12 4Q8.65 4 6.325 6.325T4 12q0 3.35 2.325 5.675T12 20m0-8"></path></svg>
    )
}
    ...
    return (
        <div className="fixed bottom-0 right-0 w-[500px] h-[230px] z-[100] my-5 mx-10" >
            ...
            <div className="relative shadow-xl bg-[#09090b] border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-center items-center gap-2">
                <h1 className="font-extrabold bg-clip-text text-transparent drop-shadow-2xl text-xl bg-gradient-to-b from-white/90 to-white/30 mt-4">
                    BetterFloat 2.0 is live!
                </h1>
                ...
                <div className="grid place-items-center justify-items-center mx-2" style={{ gridTemplateColumns: '10% 1fr' }}>
                    ...
                    <p className="font-normal text-sm text-slate-500">
                        Complete rework and redesign of the extension popup! You may want to adjust your settings again.
                    </p>
                </div>
                ...
                <div className="grid place-items-center justify-items-center mx-2" style={{ gridTemplateColumns: '10% 1fr' }}>
                    ...
                    <p className="font-normal text-sm text-slate-500">
                        Some new features are already live, and more are coming soon!
                    </p>
                </div>
