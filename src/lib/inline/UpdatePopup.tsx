			...
			<div className="relative w-[600px]">
				...
				<div className="relative shadow-xl bg-card border border-gray-800 p-4 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
					<Button
						variant="ghost"
						size="icon"
						className="bf-close-button absolute top-4 right-4 text-white"
						onClick={closePopup}
					>
						X
					</Button>
					...
					<p className="font-normal text-base text-slate-500 mb-4 relative z-50">
						🚀 Prepare for a huge update with many new markets in the next few
						days!
						<br />
						⚠️ Unfortunately, we have to request new permissions for the new
						markets.
					...
					<div className="w-full flex items-center justify-end">
						<Button
							...
							onClick={() => window.open("https://betterfloat.com/permissions")}
						>
							Learn more
						</Button>
					</div>
