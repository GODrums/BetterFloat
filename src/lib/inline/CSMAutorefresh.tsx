...
const CSMAutorefresh: React.FC = () => {
	...
	const refreshButton = document.querySelector<HTMLButtonElement>(CSMONEY_SELECTORS.market.reloadButton);
					...
					<div ref={ref}>
						...
						>
							...
							<div className="flex items-center gap-2 mt-2">
								<Switch checked={isActive} onCheckedChange={setActive} disabled={user?.plan.type !== 'pro'} />
								<MaterialSymbolsAvgTimeOutlineRounded className="ml-2 h-6 w-6 text-[#edeeffa3]" />
								<select
