            ...
            <ScrollArea className="h-full w-full py-2 px-2">
                ...
                <div className="">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <SettingsCard>
                            <SettingsCheckbox
                                id="sp-csbluegem" text="CSBlueGem Integration" icon={<img className="h-6 w-6" src={csbluegemLogo} alt="CSBlueGem Logo" />} tooltipText="Adds pattern details and past sales to case hardened skins. Data powered by CSBlueGem.com." />
                        </SettingsCard>
                    </div>
                </div>
                <div className="">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <SettingsCard>
                            <SettingsCheckbox
                                id="sp-steamprices" text="Show Steam Prices" icon={<MdiSteam className="h-6 w-6" />} />
                        </SettingsCard>
                        <SettingsCard>
                            <SettingsCheckbox
                                id="sp-buffdifference" text="Show Buff Price Difference" tooltipText="Recalculates and replaces the original discount tag according to the item's Buff price in absolute units." icon={<IcOutlineDiscount className="h-6 w-6" />} />
                        </SettingsCard>
                        <SettingsCard>
                            <SettingsCheckbox
                ...
                <div className="mb-2">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <SettingsCard>
                            <SettingsSelect id="sp-bufflink" text="Buff Link Position" options={["Action Button", "Text Link"]} tooltipText="Define the placement of the Buff link. Per default it is located in the action bar. Alternatively you it can be placed as on-click for the buff prices." />
                        </SettingsCard>
                        <SettingsCard>
                            <SettingsCheckbox
                                id="sp-floatcoloring" text="Low/High Float Coloring" tooltipText="Low and high floats in respect to each condition will get colored. 0.000X and 0.999X floats get the most prominent coloring." />
                        </SettingsCard>
                        <SettingsCard>
                            <SettingsCheckbox
                                id="sp-autoclosepopup" text="Auto-Close Popup" tooltipText="Automatically closes the 'items in cart have been sold'-popup after 5 seconds." />
                        </SettingsCard>
