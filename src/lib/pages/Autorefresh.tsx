    ...
    return (
        <div className='bg-transparent' style={{ fontFamily: 'Roboto, "Helvetica Neue", sans-serif' }}>
            ...
            <AnimatePresence>
                {open &&
                    <motion.div
                        className='fixed z-[9999] bg-[#15171ccc] border-2 border-[#c1ceff12] flex flex-col items-center gap-2 p-6 text-center'
                        style={{ translate: '-30px 10px', borderRadius: '12px', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
