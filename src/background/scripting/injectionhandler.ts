 ...
 */
export const INJECTION_DOMAINS = ['csfloat.com', 'skinport.com', 'skinbid.com', 'buff.market', 'cs.money', 'dmarket.com', 'skinbaron.de', 'bitskins.com', 'shadowpay.com', 'waxpeer.com'];
