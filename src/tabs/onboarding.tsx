					...
					<div className="col-span-2">
						<Card className="shadow-md border-muted mx-1">
							<CardContent className="h-full grid grid-cols-3 gap-4">
								<p className="text-neutral-100 text-2xl font-semibold text-center col-span-3">
								...
								<div className="col-span-2 space-y-4">
									<Card className="shadow-md border-muted mx-1 p-4">
										...
										<CardContent className="h-full flex justify-center items-center gap-8 mx-4">
								...
								<div className="col-span-3 w-full flex justify-center my-6">
